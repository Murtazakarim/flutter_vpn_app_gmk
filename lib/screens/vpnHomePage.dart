                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              con.stage.value == VPNStage.connected
                                  ? "Connected"
                                  : "Disconnected",
                    ...
                    child: AvatarGlow(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                              color: con.isConnected.value
                                  ? AppColors.colorLightGreen
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Image.asset(
                              'icons/flags/png/${con.vpnData.isNotEmpty ? con.vpnData[0][6].toString().toLowerCase() : 'us'}.png',
                            ...
                            Text(
                              con.vpnData.isNotEmpty
                                  ? con.vpnData[0][5].toString()
                                  : 'United State',
                              style:
